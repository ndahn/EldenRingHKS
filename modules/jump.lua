...
ExecJump = hookup_function(ExecJump)
ExecJumpLoopDirect = hookup_function(ExecJumpLoopDirect)
Act_Jump = hookup_function(Act_Jump)
JumpCommonFunction = hookup_function(JumpCommonFunction)
JumpLandCommonFunction = hookup_function(JumpLandCommonFunction)
Jump_Activate = hookup_function(Jump_Activate)
Jump_Update = hookup_function(Jump_Update)
Jump_Overweight_onActivate = hookup_function(Jump_Overweight_onActivate)
Jump_Overweight_onUpdate = hookup_function(Jump_Overweight_onUpdate)
Jump_Overweight_onDeactivate = hookup_function(Jump_Overweight_onDeactivate)
Jump_N_onActivate = hookup_function(Jump_N_onActivate)
Jump_N_onUpdate = hookup_function(Jump_N_onUpdate)
Jump_N_onDeactivate = hookup_function(Jump_N_onDeactivate)
Jump_F_onActivate = hookup_function(Jump_F_onActivate)
Jump_F_onUpdate = hookup_function(Jump_F_onUpdate)
Jump_F_onDeactivate = hookup_function(Jump_F_onDeactivate)
Jump_D_onActivate = hookup_function(Jump_D_onActivate)
Jump_D_onUpdate = hookup_function(Jump_D_onUpdate)
Jump_D_onDeactivate = hookup_function(Jump_D_onDeactivate)
Jump_Loop_onUpdate = hookup_function(Jump_Loop_onUpdate)
Jump_Loop_onDeactivate = hookup_function(Jump_Loop_onDeactivate)
Jump_Land_N_onUpdate = hookup_function(Jump_Land_N_onUpdate)
Jump_Land_N_onDeactivate = hookup_function(Jump_Land_N_onDeactivate)
Jump_Land_F_onUpdate = hookup_function(Jump_Land_F_onUpdate)
Jump_Land_D_onUpdate = hookup_function(Jump_Land_D_onUpdate)
Jump_Land_To_Run_onUpdate = hookup_function(Jump_Land_To_Run_onUpdate)
Jump_Land_To_Dash_onUpdate = hookup_function(Jump_Land_To_Dash_onUpdate)
JumpDamage_Start_onActivate = hookup_function(JumpDamage_Start_onActivate)
JumpDamage_Start_onUpdate = hookup_function(JumpDamage_Start_onUpdate)
JumpDamage_Land_onActivate = hookup_function(JumpDamage_Land_onActivate)
JumpDamage_Land_onUpdate = hookup_function(JumpDamage_Land_onUpdate)
