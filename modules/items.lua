...
IsUseStaminaItem = hookup_function(IsUseStaminaItem)
ExecItem = hookup_function(ExecItem)
ExecStealthItem = hookup_function(ExecStealthItem)
ExecLadderItem = hookup_function(ExecLadderItem)
ItemCommonFunction = hookup_function(ItemCommonFunction)
StealthItemCommonFunction = hookup_function(StealthItemCommonFunction)
MoveStartonCancelTiming = hookup_function(MoveStartonCancelTiming)
QuickItemCommonFunction = hookup_function(QuickItemCommonFunction)
Item_Upper_Activate = hookup_function(Item_Upper_Activate)
Item_Upper_Update = hookup_function(Item_Upper_Update)
QuickItemEnchantNormal_Upper_onUpdate = hookup_function(QuickItemEnchantNormal_Upper_onUpdate)
QuickItemEnchantDash_Upper_onActivate = hookup_function(QuickItemEnchantDash_Upper_onActivate)
QuickItemEnchantDash_Upper_onUpdate = hookup_function(QuickItemEnchantDash_Upper_onUpdate)
QuickItemEnchantStep_Upper_onUpdate = hookup_function(QuickItemEnchantStep_Upper_onUpdate)
QuickItemEnchantAttackRight_Upper_onUpdate = hookup_function(QuickItemEnchantAttackRight_Upper_onUpdate)
QuickItemEnchantAttackLeft_Upper_onUpdate = hookup_function(QuickItemEnchantAttackLeft_Upper_onUpdate)
QuickItemThrowKnifeNormal_Upper_onUpdate = hookup_function(QuickItemThrowKnifeNormal_Upper_onUpdate)
QuickItemThrowKnifeDash_Upper_onUpdate = hookup_function(QuickItemThrowKnifeDash_Upper_onUpdate)
QuickItemThrowKnifeStep_Upper_onUpdate = hookup_function(QuickItemThrowKnifeStep_Upper_onUpdate)
QuickItemThrowKnifeAttackRight_Upper_onUpdate = hookup_function(QuickItemThrowKnifeAttackRight_Upper_onUpdate)
QuickItemThrowKnifeAttackRight2_Upper_onUpdate = hookup_function(QuickItemThrowKnifeAttackRight2_Upper_onUpdate)
QuickItemThrowKnifeAttackLeft_Upper_onUpdate = hookup_function(QuickItemThrowKnifeAttackLeft_Upper_onUpdate)
QuickItemThrowKnifeAttackLeft2_Upper_onUpdate = hookup_function(QuickItemThrowKnifeAttackLeft2_Upper_onUpdate)
ItemRecover_Upper_onUpdate = hookup_function(ItemRecover_Upper_onUpdate)
ItemEatJerky_Upper_onUpdate = hookup_function(ItemEatJerky_Upper_onUpdate)
ItemLanternOn_Upper_onUpdate = hookup_function(ItemLanternOn_Upper_onUpdate)
ItemLanternOff_Upper_onUpdate = hookup_function(ItemLanternOff_Upper_onUpdate)
ItemElixir_Upper_onUpdate = hookup_function(ItemElixir_Upper_onUpdate)
ItemHorn_Upper_onUpdate = hookup_function(ItemHorn_Upper_onUpdate)
ItemWeaponEnchant_Upper_onUpdate = hookup_function(ItemWeaponEnchant_Upper_onUpdate)
ItemThrowKnife_Upper_onUpdate = hookup_function(ItemThrowKnife_Upper_onUpdate)
ItemThrowBottle_Upper_onUpdate = hookup_function(ItemThrowBottle_Upper_onUpdate)
ItemMeganeStart_Upper_onUpdate = hookup_function(ItemMeganeStart_Upper_onUpdate)
ItemMeganeLoop_Upper_onUpdate = hookup_function(ItemMeganeLoop_Upper_onUpdate)
ItemMeganeEnd_Upper_onUpdate = hookup_function(ItemMeganeEnd_Upper_onUpdate)
ItemWeaponRepair_Upper_onUpdate = hookup_function(ItemWeaponRepair_Upper_onUpdate)
ItemSoul_Upper_onUpdate = hookup_function(ItemSoul_Upper_onUpdate)
ItemMessage_Upper_onUpdate = hookup_function(ItemMessage_Upper_onUpdate)
ItemPray_Upper_onUpdate = hookup_function(ItemPray_Upper_onUpdate)
ItemTrap_Upper_onUpdate = hookup_function(ItemTrap_Upper_onUpdate)
ItemDrinkStart_Upper_onUpdate = hookup_function(ItemDrinkStart_Upper_onUpdate)
ItemDrinkNothing_Upper_onUpdate = hookup_function(ItemDrinkNothing_Upper_onUpdate)
ItemDrinking_Upper_onUpdate = hookup_function(ItemDrinking_Upper_onUpdate)
ItemDrinkEnd_Upper_onUpdate = hookup_function(ItemDrinkEnd_Upper_onUpdate)
ItemShockWeaveStart_Upper_onUpdate = hookup_function(ItemShockWeaveStart_Upper_onUpdate)
ItemShockWeaveEnd_Upper_onUpdate = hookup_function(ItemShockWeaveEnd_Upper_onUpdate)
ItemDrinkStartMP_Upper_onUpdate = hookup_function(ItemDrinkStartMP_Upper_onUpdate)
ItemDrinkingMP_Upper_onUpdate = hookup_function(ItemDrinkingMP_Upper_onUpdate)
ItemThrowSpear_Upper_onUpdate = hookup_function(ItemThrowSpear_Upper_onUpdate)
DragonFullStartAfter_Upper_onUpdate = hookup_function(DragonFullStartAfter_Upper_onUpdate)
ItemPrayMulti_Upper_onUpdate = hookup_function(ItemPrayMulti_Upper_onUpdate)
ItemReturnBuddy_Upper_onUpdate = hookup_function(ItemReturnBuddy_Upper_onUpdate)
ItemSummonBuddy_Upper_onUpdate = hookup_function(ItemSummonBuddy_Upper_onUpdate)
ItemCopySleep_Upper_onUpdate = hookup_function(ItemCopySleep_Upper_onUpdate)
ItemVoice_Upper_onUpdate = hookup_function(ItemVoice_Upper_onUpdate)
ItemHolySymbol_Upper_onUpdate = hookup_function(ItemHolySymbol_Upper_onUpdate)
ItemHost_Upper_onUpdate = hookup_function(ItemHost_Upper_onUpdate)
ItemMultKick_Upper_onUpdate = hookup_function(ItemMultKick_Upper_onUpdate)
ItemTongue_Upper_onUpdate = hookup_function(ItemTongue_Upper_onUpdate)
ItemThrowBackBottle_Upper_onUpdate = hookup_function(ItemThrowBackBottle_Upper_onUpdate)
ItemAromaWide_Upper_onUpdate = hookup_function(ItemAromaWide_Upper_onUpdate)
ItemAromaUp_Upper_onUpdate = hookup_function(ItemAromaUp_Upper_onUpdate)
ItemAromaBreath_Upper_onUpdate = hookup_function(ItemAromaBreath_Upper_onUpdate)
ItemAromaDrink_Upper_onUpdate = hookup_function(ItemAromaDrink_Upper_onUpdate)
ItemAromaFront_Upper_onUpdate = hookup_function(ItemAromaFront_Upper_onUpdate)
ItemDrinkEmpty_Upper_onActivate = hookup_function(ItemDrinkEmpty_Upper_onActivate)
ItemDrinkEmpty_Upper_onUpdate = hookup_function(ItemDrinkEmpty_Upper_onUpdate)
ItemDragonThrowSpearMax_Upper_onUpdate = hookup_function(ItemDragonThrowSpearMax_Upper_onUpdate)
ItemDragonThrowSpearCancel_Upper_onUpdate = hookup_function(ItemDragonThrowSpearCancel_Upper_onUpdate)
ItemThrowBigBottle_Upper_onUpdate = hookup_function(ItemThrowBigBottle_Upper_onUpdate)
ItemDancingSwordsmanFire_Upper_onUpdate = hookup_function(ItemDancingSwordsmanFire_Upper_onUpdate)
ItemTransformDragonPriest_Upper_onUpdate = hookup_function(ItemTransformDragonPriest_Upper_onUpdate)
ItemTransformGodman_Upper_onUpdate = hookup_function(ItemTransformGodman_Upper_onUpdate)
ItemTransformGodmanNPC_Upper_onUpdate = hookup_function(ItemTransformGodmanNPC_Upper_onUpdate)
ItemTransformGodmanBreathNPC_Upper_onUpdate = hookup_function(ItemTransformGodmanBreathNPC_Upper_onUpdate)
ItemCrySickness_Upper_onUpdate = hookup_function(ItemCrySickness_Upper_onUpdate)
ItemCrySicknessPhantom_Upper_onUpdate = hookup_function(ItemCrySicknessPhantom_Upper_onUpdate)
ItemSwitchExplosive_Upper_onUpdate = hookup_function(ItemSwitchExplosive_Upper_onUpdate)
ItemSwitch_Upper_onUpdate = hookup_function(ItemSwitch_Upper_onUpdate)
ItemThorn_Upper_onUpdate = hookup_function(ItemThorn_Upper_onUpdate)
ItemErdtree_Upper_onUpdate = hookup_function(ItemErdtree_Upper_onUpdate)
ItemElixir2_Upper_onUpdate = hookup_function(ItemElixir2_Upper_onUpdate)
ItemOneShot_Upper_onUpdate = hookup_function(ItemOneShot_Upper_onUpdate)
ItemOneShot_SelfTrans_Upper_onUpdate = hookup_function(ItemOneShot_SelfTrans_Upper_onUpdate)
ItemCombo_Upper_onUpdate = hookup_function(ItemCombo_Upper_onUpdate)
ItemDash_Upper_onUpdate = hookup_function(ItemDash_Upper_onUpdate)
ItemInvalid_Upper_onUpdate = hookup_function(ItemInvalid_Upper_onUpdate)
ItemLadderRecoverRight_onUpdate = hookup_function(ItemLadderRecoverRight_onUpdate)
ItemLadderSoulRight_onUpdate = hookup_function(ItemLadderSoulRight_onUpdate)
ItemLadderElixirRight_onUpdate = hookup_function(ItemLadderElixirRight_onUpdate)
ItemLadderElixir2Right_onUpdate = hookup_function(ItemLadderElixir2Right_onUpdate)
ItemLadderEatJerkyRight_onUpdate = hookup_function(ItemLadderEatJerkyRight_onUpdate)
ItemLadderDrinkStartRight_onUpdate = hookup_function(ItemLadderDrinkStartRight_onUpdate)
ItemLadderDrinkingRight_onUpdate = hookup_function(ItemLadderDrinkingRight_onUpdate)
ItemLadderDrinkMPStartRight_onUpdate = hookup_function(ItemLadderDrinkMPStartRight_onUpdate)
ItemLadderDrinkingMPRight_onUpdate = hookup_function(ItemLadderDrinkingMPRight_onUpdate)
ItemLadderDrinkEndRight_onUpdate = hookup_function(ItemLadderDrinkEndRight_onUpdate)
ItemLadderDrinkEmptyRight_onUpdate = hookup_function(ItemLadderDrinkEmptyRight_onUpdate)
ItemLadderDrinkNothingRight_onUpdate = hookup_function(ItemLadderDrinkNothingRight_onUpdate)
ItemLadderInvalidRight_onUpdate = hookup_function(ItemLadderInvalidRight_onUpdate)
ItemLadderRecoverLeft_onUpdate = hookup_function(ItemLadderRecoverLeft_onUpdate)
ItemLadderSoulLeft_onUpdate = hookup_function(ItemLadderSoulLeft_onUpdate)
ItemLadderElixirLeft_onUpdate = hookup_function(ItemLadderElixirLeft_onUpdate)
ItemLadderElixir2Left_onUpdate = hookup_function(ItemLadderElixir2Left_onUpdate)
ItemLadderEatJerkyLeft_onUpdate = hookup_function(ItemLadderEatJerkyLeft_onUpdate)
ItemLadderDrinkStartLeft_onUpdate = hookup_function(ItemLadderDrinkStartLeft_onUpdate)
ItemLadderDrinkingLeft_onUpdate = hookup_function(ItemLadderDrinkingLeft_onUpdate)
ItemLadderDrinkMPStartLeft_onUpdate = hookup_function(ItemLadderDrinkMPStartLeft_onUpdate)
ItemLadderDrinkingMPLeft_onUpdate = hookup_function(ItemLadderDrinkingMPLeft_onUpdate)
ItemLadderDrinkEndLeft_onUpdate = hookup_function(ItemLadderDrinkEndLeft_onUpdate)
ItemLadderDrinkEmptyLeft_onUpdate = hookup_function(ItemLadderDrinkEmptyLeft_onUpdate)
ItemLadderDrinkNothingLeft_onUpdate = hookup_function(ItemLadderDrinkNothingLeft_onUpdate)
ItemLadderInvalidLeft_onUpdate = hookup_function(ItemLadderInvalidLeft_onUpdate)
