...
GetMoveSpeed = hookup_function(GetMoveSpeed)
SetTurnSpeed = hookup_function(SetTurnSpeed)
SetWeightIndex = hookup_function(SetWeightIndex)
GetLocomotionState = hookup_function(GetLocomotionState)
SpeedUpdate = hookup_function(SpeedUpdate)
ChangeMoveSpeedIndex = hookup_function(ChangeMoveSpeedIndex)
StealthTransitionIndexUpdate = hookup_function(StealthTransitionIndexUpdate)
IsLowerQuickTurn = hookup_function(IsLowerQuickTurn)
IsLowerBackStep = hookup_function(IsLowerBackStep)
MoveStart = hookup_function(MoveStart)
MoveStartonCancelTiming = hookup_function(MoveStartonCancelTiming)
SetMoveType = hookup_function(SetMoveType)
ExecQuickTurn = hookup_function(ExecQuickTurn)
ExecDashTurn = hookup_function(ExecDashTurn)
ExitQuickTurnLower = hookup_function(ExitQuickTurnLower)
ExecQuickTurnOnCancelTiming = hookup_function(ExecQuickTurnOnCancelTiming)
ExecFallStart = hookup_function(ExecFallStart)
ExecMovableEventAnim = hookup_function(ExecMovableEventAnim)
ExecStop = hookup_function(ExecStop)
ExecStopHalfBlend = hookup_function(ExecStopHalfBlend)
MoveCommonFunction = hookup_function(MoveCommonFunction)
QuickTurnCommonFunction = hookup_function(QuickTurnCommonFunction)
IdleCommonFunction = hookup_function(IdleCommonFunction)
StopCommonFunction = hookup_function(StopCommonFunction)
Move_Activate = hookup_function(Move_Activate)
Move_Update = hookup_function(Move_Update)
Move_onActivate = hookup_function(Move_onActivate)
Move_onUpdate = hookup_function(Move_onUpdate)
MoveNoSync_onActivate = hookup_function(MoveNoSync_onActivate)
MoveNoSync_onUpdate = hookup_function(MoveNoSync_onUpdate)
Move_Upper_onActivate = hookup_function(Move_Upper_onActivate)
Move_Upper_onUpdate = hookup_function(Move_Upper_onUpdate)
Idle_onActivate = hookup_function(Idle_onActivate)
Idle_onUpdate = hookup_function(Idle_onUpdate)
Idle_onDeactivate = hookup_function(Idle_onDeactivate)
DashStop_onActivate = hookup_function(DashStop_onActivate)
DashStop_onUpdate = hookup_function(DashStop_onUpdate)
RunStopFront_onActivate = hookup_function(RunStopFront_onActivate)
RunStopFront_onUpdate = hookup_function(RunStopFront_onUpdate)
RunStopBack_onActivate = hookup_function(RunStopBack_onActivate)
RunStopBack_onUpdate = hookup_function(RunStopBack_onUpdate)
RunStopLeft_onActivate = hookup_function(RunStopLeft_onActivate)
RunStopLeft_onUpdate = hookup_function(RunStopLeft_onUpdate)
RunStopRight_onActivate = hookup_function(RunStopRight_onActivate)
RunStopRight_onUpdate = hookup_function(RunStopRight_onUpdate)
WalkStopFront_onActivate = hookup_function(WalkStopFront_onActivate)
WalkStopFront_onUpdate = hookup_function(WalkStopFront_onUpdate)
WalkStopBack_onActivate = hookup_function(WalkStopBack_onActivate)
WalkStopBack_onUpdate = hookup_function(WalkStopBack_onUpdate)
WalkStopLeft_onActivate = hookup_function(WalkStopLeft_onActivate)
WalkStopLeft_onUpdate = hookup_function(WalkStopLeft_onUpdate)
WalkStopRight_onActivate = hookup_function(WalkStopRight_onActivate)
WalkStopRight_onUpdate = hookup_function(WalkStopRight_onUpdate)
Dash180_onActivate = hookup_function(Dash180_onActivate)
Dash180_onUpdate = hookup_function(Dash180_onUpdate)
QuickTurnLeft180_Upper_onUpdate = hookup_function(QuickTurnLeft180_Upper_onUpdate)
QuickTurnRight180_Upper_onUpdate = hookup_function(QuickTurnRight180_Upper_onUpdate)
