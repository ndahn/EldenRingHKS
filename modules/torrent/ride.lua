...
ExecRideEventAnim = hookup_function(ExecRideEventAnim)
Ride_Activate = hookup_function(Ride_Activate)
Ride_Update = hookup_function(Ride_Update)
Ride_Deactivate = hookup_function(Ride_Deactivate)
Ride_NoThrow_Activate = hookup_function(Ride_NoThrow_Activate)
Ride_NoThrow_Update = hookup_function(Ride_NoThrow_Update)
ExecRide = hookup_function(ExecRide)
FireRideEvent = hookup_function(FireRideEvent)
FireRideEventNoReset = hookup_function(FireRideEventNoReset)
ExecRideOff = hookup_function(ExecRideOff)
RideReActionFunction = hookup_function(RideReActionFunction)
ExecRideDeath = hookup_function(ExecRideDeath)
ExecRideDamage = hookup_function(ExecRideDamage)
RideRequestFunction = hookup_function(RideRequestFunction)
ExecRideStop = hookup_function(ExecRideStop)
ExecRideDashAccelerate = hookup_function(ExecRideDashAccelerate)
RideCommonFunction = hookup_function(RideCommonFunction)
RideFallCommonFunction = hookup_function(RideFallCommonFunction)
RideAdjust_onUpdate = hookup_function(RideAdjust_onUpdate)
RideAdjustFromCalling_onUpdate = hookup_function(RideAdjustFromCalling_onUpdate)
RideOn_onUpdate = hookup_function(RideOn_onUpdate)
RideOff_onUpdate = hookup_function(RideOff_onUpdate)
RideIdle_onActivate = hookup_function(RideIdle_onActivate)
RideIdle_onUpdate = hookup_function(RideIdle_onUpdate)
RideWalk_onUpdate = hookup_function(RideWalk_onUpdate)
RideWalk_End_onUpdate = hookup_function(RideWalk_End_onUpdate)
RideOnDash_onUpdate = hookup_function(RideOnDash_onUpdate)
RideDash_onUpdate = hookup_function(RideDash_onUpdate)
RideDashAccelerate_onUpdate = hookup_function(RideDashAccelerate_onUpdate)
RideDashAccelerateContinue_onUpdate = hookup_function(RideDashAccelerateContinue_onUpdate)
RideMoveStaminaConsume = hookup_function(RideMoveStaminaConsume)
RideDash_End_onUpdate = hookup_function(RideDash_End_onUpdate)
RideGallop_onUpdate = hookup_function(RideGallop_onUpdate)
RideGallop_End_onUpdate = hookup_function(RideGallop_End_onUpdate)
Ride_SA_Add_Default_onUpdate = hookup_function(Ride_SA_Add_Default_onUpdate)
RideDeath_Idle_onActivate = hookup_function(RideDeath_Idle_onActivate)
RideDeath_Idle_onDeactivate = hookup_function(RideDeath_Idle_onDeactivate)
RideTurn_Left180_onUpdate = hookup_function(RideTurn_Left180_onUpdate)
RideTurn_Left180_onDeactivate = hookup_function(RideTurn_Left180_onDeactivate)
RideTurn_Right180_onUpdate = hookup_function(RideTurn_Right180_onUpdate)
RideTurn_Right180_onDeactivate = hookup_function(RideTurn_Right180_onDeactivate)
RideTurn_Left90_onUpdate = hookup_function(RideTurn_Left90_onUpdate)
RideTurn_Left90_onDeactivate = hookup_function(RideTurn_Left90_onDeactivate)
RideTurn_Right90_onUpdate = hookup_function(RideTurn_Right90_onUpdate)
RideFall_Start_onUpdate = hookup_function(RideFall_Start_onUpdate)
RideFall_Loop_onUpdate = hookup_function(RideFall_Loop_onUpdate)
RideFall_Land_onUpdate = hookup_function(RideFall_Land_onUpdate)
RideTurn_Right90_onDeactivate = hookup_function(RideTurn_Right90_onDeactivate)
