...
ExecRideAttack = hookup_function(ExecRideAttack)
IsEnableRideAttackHard2 = hookup_function(IsEnableRideAttackHard2)
RideAttackCommonFunction = hookup_function(RideAttackCommonFunction)
RideJumpAttackCommonFunction = hookup_function(RideJumpAttackCommonFunction)
RideRepelledWall_onUpdate = hookup_function(RideRepelledWall_onUpdate)
RideRepelledSmall_onUpdate = hookup_function(RideRepelledSmall_onUpdate)
RideRepelledLarge_onUpdate = hookup_function(RideRepelledLarge_onUpdate)
RideAttack_BackKick_onActivate = hookup_function(RideAttack_BackKick_onActivate)
RideAttack_BackKick_onUpdate = hookup_function(RideAttack_BackKick_onUpdate)
RideAttack_BackKick_onDeactivate = hookup_function(RideAttack_BackKick_onDeactivate)
RideAttack_R_Top_onActivate = hookup_function(RideAttack_R_Top_onActivate)
RideAttack_R_Top_onUpdate = hookup_function(RideAttack_R_Top_onUpdate)
RideAttack_R_Top_onDeactivate = hookup_function(RideAttack_R_Top_onDeactivate)
RideAttack_R_Top02_onActivate = hookup_function(RideAttack_R_Top02_onActivate)
RideAttack_R_Top02_onUpdate = hookup_function(RideAttack_R_Top02_onUpdate)
RideAttack_R_Top02_onDeactivate = hookup_function(RideAttack_R_Top02_onDeactivate)
RideAttack_R_Top03_onActivate = hookup_function(RideAttack_R_Top03_onActivate)
RideAttack_R_Top03_onUpdate = hookup_function(RideAttack_R_Top03_onUpdate)
RideAttack_R_Top03_onDeactivate = hookup_function(RideAttack_R_Top03_onDeactivate)
RideAttack_R_Hard1_Start_onActivate = hookup_function(RideAttack_R_Hard1_Start_onActivate)
RideAttack_R_Hard1_Start_onUpdate = hookup_function(RideAttack_R_Hard1_Start_onUpdate)
RideAttack_R_Hard1_Start_onDeactivate = hookup_function(RideAttack_R_Hard1_Start_onDeactivate)
RideAttack_R_Hard1_End_onActivate = hookup_function(RideAttack_R_Hard1_End_onActivate)
RideAttack_R_Hard1_End_onUpdate = hookup_function(RideAttack_R_Hard1_End_onUpdate)
RideAttack_R_Hard1_End_onDeactivate = hookup_function(RideAttack_R_Hard1_End_onDeactivate)
RideAttack_R_Hard2_Start_onActivate = hookup_function(RideAttack_R_Hard2_Start_onActivate)
RideAttack_R_Hard2_Start_onUpdate = hookup_function(RideAttack_R_Hard2_Start_onUpdate)
RideAttack_R_Hard2_Start_onDeactivate = hookup_function(RideAttack_R_Hard2_Start_onDeactivate)
RideAttack_R_Hard2_End_onActivate = hookup_function(RideAttack_R_Hard2_End_onActivate)
RideAttack_R_Hard2_End_onUpdate = hookup_function(RideAttack_R_Hard2_End_onUpdate)
RideAttack_R_Hard2_End_onDeactivate = hookup_function(RideAttack_R_Hard2_End_onDeactivate)
RideAttack_L_Hard1_Start_onActivate = hookup_function(RideAttack_L_Hard1_Start_onActivate)
RideAttack_L_Hard1_Start_onUpdate = hookup_function(RideAttack_L_Hard1_Start_onUpdate)
RideAttack_L_Hard1_Start_onDeactivate = hookup_function(RideAttack_L_Hard1_Start_onDeactivate)
RideAttack_L_Hard1_End_onActivate = hookup_function(RideAttack_L_Hard1_End_onActivate)
RideAttack_L_Hard1_End_onUpdate = hookup_function(RideAttack_L_Hard1_End_onUpdate)
RideAttack_L_Hard1_End_onDeactivate = hookup_function(RideAttack_L_Hard1_End_onDeactivate)
RideAttack_L_Hard2_Start_onActivate = hookup_function(RideAttack_L_Hard2_Start_onActivate)
RideAttack_L_Hard2_Start_onUpdate = hookup_function(RideAttack_L_Hard2_Start_onUpdate)
RideAttack_L_Hard2_Start_onDeactivate = hookup_function(RideAttack_L_Hard2_Start_onDeactivate)
RideAttack_L_Hard2_End_onActivate = hookup_function(RideAttack_L_Hard2_End_onActivate)
RideAttack_L_Hard2_End_onUpdate = hookup_function(RideAttack_L_Hard2_End_onUpdate)
RideAttack_L_Hard2_End_onDeactivate = hookup_function(RideAttack_L_Hard2_End_onDeactivate)
RideAttack_L_Top_onActivate = hookup_function(RideAttack_L_Top_onActivate)
RideAttack_L_Top_onUpdate = hookup_function(RideAttack_L_Top_onUpdate)
RideAttack_L_Top_onDeactivate = hookup_function(RideAttack_L_Top_onDeactivate)
RideAttack_L_Top02_onActivate = hookup_function(RideAttack_L_Top02_onActivate)
RideAttack_L_Top02_onUpdate = hookup_function(RideAttack_L_Top02_onUpdate)
RideAttack_L_Top02_onDeactivate = hookup_function(RideAttack_L_Top02_onDeactivate)
RideAttack_L_Top03_onActivate = hookup_function(RideAttack_L_Top03_onActivate)
RideAttack_L_Top03_onUpdate = hookup_function(RideAttack_L_Top03_onUpdate)
RideAttack_L_Top03_onDeactivate = hookup_function(RideAttack_L_Top03_onDeactivate)
RideAttackArrowStart_onUpdate = hookup_function(RideAttackArrowStart_onUpdate)
RideAttackArrowStartContinue_onUpdate = hookup_function(RideAttackArrowStartContinue_onUpdate)
RideAttackArrowLoop_onUpdate = hookup_function(RideAttackArrowLoop_onUpdate)
RideAttackArrowFire_onUpdate = hookup_function(RideAttackArrowFire_onUpdate)
RideAttackArrowFire_onDeactivate = hookup_function(RideAttackArrowFire_onDeactivate)
RideAttackCrossbowLeftFire_onUpdate = hookup_function(RideAttackCrossbowLeftFire_onUpdate)
RideAttackCrossbowLeftFire_onDeactivate = hookup_function(RideAttackCrossbowLeftFire_onDeactivate)
RideNoArrow_onUpdate = hookup_function(RideNoArrow_onUpdate)
RideAttackCrossbowRightReload_onUpdate = hookup_function(RideAttackCrossbowRightReload_onUpdate)
RideAttackCrossbowLeftReload_onUpdate = hookup_function(RideAttackCrossbowLeftReload_onUpdate)
RideAttack_Jump_R_onActivate = hookup_function(RideAttack_Jump_R_onActivate)
RideAttack_Jump_R_onUpdate = hookup_function(RideAttack_Jump_R_onUpdate)
RideAttack_Jump_R_Hard1_onActivate = hookup_function(RideAttack_Jump_R_Hard1_onActivate)
RideAttack_Jump_R_Hard1_onUpdate = hookup_function(RideAttack_Jump_R_Hard1_onUpdate)
RideAttack_Jump_R_Hard2_onActivate = hookup_function(RideAttack_Jump_R_Hard2_onActivate)
RideAttack_Jump_R_Hard2_onUpdate = hookup_function(RideAttack_Jump_R_Hard2_onUpdate)
RideAttack_Jump_L_onActivate = hookup_function(RideAttack_Jump_L_onActivate)
RideAttack_Jump_L_onUpdate = hookup_function(RideAttack_Jump_L_onUpdate)
RideAttack_Jump_L_Hard1_onActivate = hookup_function(RideAttack_Jump_L_Hard1_onActivate)
RideAttack_Jump_L_Hard1_onUpdate = hookup_function(RideAttack_Jump_L_Hard1_onUpdate)
RideAttack_Jump_L_Hard2_onActivate = hookup_function(RideAttack_Jump_L_Hard2_onActivate)
RideAttack_Jump_L_Hard2_onUpdate = hookup_function(RideAttack_Jump_L_Hard2_onUpdate)
