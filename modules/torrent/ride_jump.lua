...
RideJumpCommonFunction = hookup_function(RideJumpCommonFunction)
RideJump_N_onActivate = hookup_function(RideJump_N_onActivate)
RideJump_N_onUpdate = hookup_function(RideJump_N_onUpdate)
RideJump_F_onActivate = hookup_function(RideJump_F_onActivate)
RideJump_F_onUpdate = hookup_function(RideJump_F_onUpdate)
RideJump_D_onActivate = hookup_function(RideJump_D_onActivate)
RideJump_D_onUpdate = hookup_function(RideJump_D_onUpdate)
RideJump_Loop_onActivate = hookup_function(RideJump_Loop_onActivate)
RideJump_Loop_onUpdate = hookup_function(RideJump_Loop_onUpdate)
RideJump2_N_onActivate = hookup_function(RideJump2_N_onActivate)
RideJump2_N_onUpdate = hookup_function(RideJump2_N_onUpdate)
RideJump2_F_onActivate = hookup_function(RideJump2_F_onActivate)
RideJump2_F_onUpdate = hookup_function(RideJump2_F_onUpdate)
RideJump2_D_onActivate = hookup_function(RideJump2_D_onActivate)
RideJump2_D_onUpdate = hookup_function(RideJump2_D_onUpdate)
RideJump2_Loop_onActivate = hookup_function(RideJump2_Loop_onActivate)
RideJump2_Loop_onUpdate = hookup_function(RideJump2_Loop_onUpdate)
RideJump_Land_N_onActivate = hookup_function(RideJump_Land_N_onActivate)
RideJump_Land_N_onUpdate = hookup_function(RideJump_Land_N_onUpdate)
RideJump_Land_F_onActivate = hookup_function(RideJump_Land_F_onActivate)
RideJump_Land_F_onUpdate = hookup_function(RideJump_Land_F_onUpdate)
RideJump_Land_D_onActivate = hookup_function(RideJump_Land_D_onActivate)
RideJump_Land_D_onUpdate = hookup_function(RideJump_Land_D_onUpdate)
RideJump_Land_To_Dash_onActivate = hookup_function(RideJump_Land_To_Dash_onActivate)
RideJump_Land_To_Dash_onUpdate = hookup_function(RideJump_Land_To_Dash_onUpdate)
RideJump_Land_To_Gallop_onActivate = hookup_function(RideJump_Land_To_Gallop_onActivate)
RideJump_Land_To_Gallop_onUpdate = hookup_function(RideJump_Land_To_Gallop_onUpdate)
RideJumpHigh_onActivate = hookup_function(RideJumpHigh_onActivate)
RideJumpHigh_onUpdate = hookup_function(RideJumpHigh_onUpdate)
RideJumpHighLoop_onActivate = hookup_function(RideJumpHighLoop_onActivate)
RideJumpHighLoop_onUpdate = hookup_function(RideJumpHighLoop_onUpdate)
RideJumpHighEnd_onActivate = hookup_function(RideJumpHighEnd_onActivate)
RideJumpHighEnd_onUpdate = hookup_function(RideJumpHighEnd_onUpdate)
RideJumpHigh2_onActivate = hookup_function(RideJumpHigh2_onActivate)
RideJumpHigh2_onUpdate = hookup_function(RideJumpHigh2_onUpdate)
RideJumpHigh_FallLoop_onActivate = hookup_function(RideJumpHigh_FallLoop_onActivate)
RideJumpHigh_FallLoop_onUpdate = hookup_function(RideJumpHigh_FallLoop_onUpdate)
RideJump_onActivate = hookup_function(RideJump_onActivate)
RideJump_onUpdate = hookup_function(RideJump_onUpdate)
Jump_RideOff_onActivate = hookup_function(Jump_RideOff_onActivate)
Jump_RideOff_onUpdate = hookup_function(Jump_RideOff_onUpdate)
Jump_RideOff_onDeactivate = hookup_function(Jump_RideOff_onDeactivate)
Jump_Loop_onActivate = hookup_function(Jump_Loop_onActivate)
