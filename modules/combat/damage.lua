...
ExecAddDamage = hookup_function(ExecAddDamage)
ExecPassiveAction = hookup_function(ExecPassiveAction)
CalcDamageCount = hookup_function(CalcDamageCount)
ResetDamageCount = hookup_function(ResetDamageCount)
ExecDamage = hookup_function(ExecDamage)
DamageCommonFunction = hookup_function(DamageCommonFunction)
Damage_Activate = hookup_function(Damage_Activate)
Damage_Update = hookup_function(Damage_Update)
Damage_NoThrowDef_Update = hookup_function(Damage_NoThrowDef_Update)
DamageSABreak_onUpdate = hookup_function(DamageSABreak_onUpdate)
DamageSleepResist_onUpdate = hookup_function(DamageSleepResist_onUpdate)
DamageMad_onUpdate = hookup_function(DamageMad_onUpdate)
DamageBind_onActivate = hookup_function(DamageBind_onActivate)
DamageBind_onUpdate = hookup_function(DamageBind_onUpdate)
DamageLv1_Small_onUpdate = hookup_function(DamageLv1_Small_onUpdate)
DamageLv2_Middle_onUpdate = hookup_function(DamageLv2_Middle_onUpdate)
DamageLv3_Large_onUpdate = hookup_function(DamageLv3_Large_onUpdate)
DamageLarge2_onUpdate = hookup_function(DamageLarge2_onUpdate)
DamageWeak_onUpdate = hookup_function(DamageWeak_onUpdate)
DamageLv8_Minimum_onUpdate = hookup_function(DamageLv8_Minimum_onUpdate)
DamageLv6_Fling_onUpdate = hookup_function(DamageLv6_Fling_onUpdate)
DamageLv4_ExLarge_onUpdate = hookup_function(DamageLv4_ExLarge_onUpdate)
DamageLv5_Push_onUpdate = hookup_function(DamageLv5_Push_onUpdate)
DamageLv7_SmallBlow_onUpdate = hookup_function(DamageLv7_SmallBlow_onUpdate)
DamageLv9_Upper_onUpdate = hookup_function(DamageLv9_Upper_onUpdate)
DamageLV10_ExBlast_onUpdate = hookup_function(DamageLV10_ExBlast_onUpdate)
DamageLv11_Breath_onUpdate = hookup_function(DamageLv11_Breath_onUpdate)
DamageParry_onUpdate = hookup_function(DamageParry_onUpdate)
AddDamageDefault_onUpdate = hookup_function(AddDamageDefault_onUpdate)
AddDamageDefaultGuard_onUpdate = hookup_function(AddDamageDefaultGuard_onUpdate)
DamageDirNoAdd_onUpdate = hookup_function(DamageDirNoAdd_onUpdate)
AddDamageLv0_Default_onUpdate = hookup_function(AddDamageLv0_Default_onUpdate)
