...
IsWeaponCanGuard = hookup_function(IsWeaponCanGuard)
IsEnableGuard = hookup_function(IsEnableGuard)
ExecGuard = hookup_function(ExecGuard)
IsGuard = hookup_function(IsGuard)
ExecGuardOnCancelTiming = hookup_function(ExecGuardOnCancelTiming)
SetJustGuardSucceedEffect = hookup_function(SetJustGuardSucceedEffect)
SetJustGuardReinputState = hookup_function(SetJustGuardReinputState)
GuardCommonFunction = hookup_function(GuardCommonFunction)
JustGuardStartCommonFunction = hookup_function(JustGuardStartCommonFunction)
Guard_Activate = hookup_function(Guard_Activate)
Guard_Update = hookup_function(Guard_Update)
GuardDamage_Active = hookup_function(GuardDamage_Active)
GuardDamage_Update = hookup_function(GuardDamage_Update)
BackStepGuardOn_Upper_Active = hookup_function(BackStepGuardOn_Upper_Active)
BackStepGuardOn_Upper_Update = hookup_function(BackStepGuardOn_Upper_Update)
BackStepGuardEnd_Upper_Active = hookup_function(BackStepGuardEnd_Upper_Active)
BackStepGuardEnd_Upper_Update = hookup_function(BackStepGuardEnd_Upper_Update)
GuardStart_Upper_onActivate = hookup_function(GuardStart_Upper_onActivate)
GuardStart_Upper_onUpdate = hookup_function(GuardStart_Upper_onUpdate)
GuardStart_Upper_onDeactivate = hookup_function(GuardStart_Upper_onDeactivate)
GuardOn_Upper_onActivate = hookup_function(GuardOn_Upper_onActivate)
GuardOn_Upper_onUpdate = hookup_function(GuardOn_Upper_onUpdate)
GuardOn_Upper_onDeactivate = hookup_function(GuardOn_Upper_onDeactivate)
GuardEnd_Upper_onActivate = hookup_function(GuardEnd_Upper_onActivate)
GuardEnd_Upper_onUpdate = hookup_function(GuardEnd_Upper_onUpdate)
GuardStart_JustGuard_Upper_onActivate = hookup_function(GuardStart_JustGuard_Upper_onActivate)
GuardStart_JustGuard_Upper_onUpdate = hookup_function(GuardStart_JustGuard_Upper_onUpdate)
GuardStart_JustGuard_Upper_onDeactivate = hookup_function(GuardStart_JustGuard_Upper_onDeactivate)
GuardStart_JustGuard_SelfTrans_Upper_onActivate = hookup_function(GuardStart_JustGuard_SelfTrans_Upper_onActivate)
GuardStart_JustGuard_SelfTrans_Upper_onUpdate = hookup_function(GuardStart_JustGuard_SelfTrans_Upper_onUpdate)
GuardStart_JustGuard_SelfTrans_Upper_onDeactivate = hookup_function(GuardStart_JustGuard_SelfTrans_Upper_onDeactivate)
GuardStart_JustGuard2_Upper_onActivate = hookup_function(GuardStart_JustGuard2_Upper_onActivate)
GuardStart_JustGuard2_Upper_onUpdate = hookup_function(GuardStart_JustGuard2_Upper_onUpdate)
GuardStart_JustGuard2_Upper_onDeactivate = hookup_function(GuardStart_JustGuard2_Upper_onDeactivate)
GuardStart_JustGuard3_Upper_onActivate = hookup_function(GuardStart_JustGuard3_Upper_onActivate)
GuardStart_JustGuard3_Upper_onUpdate = hookup_function(GuardStart_JustGuard3_Upper_onUpdate)
GuardStart_JustGuard3_Upper_onDeactivate = hookup_function(GuardStart_JustGuard3_Upper_onDeactivate)
GuardStart_JustGuard4_Upper_onActivate = hookup_function(GuardStart_JustGuard4_Upper_onActivate)
GuardStart_JustGuard4_Upper_onUpdate = hookup_function(GuardStart_JustGuard4_Upper_onUpdate)
GuardStart_JustGuard4_Upper_onDeactivate = hookup_function(GuardStart_JustGuard4_Upper_onDeactivate)
GuardStart_JustGuard4_SelfTrans_Upper_onActivate = hookup_function(GuardStart_JustGuard4_SelfTrans_Upper_onActivate)
GuardStart_JustGuard4_SelfTrans_Upper_onUpdate = hookup_function(GuardStart_JustGuard4_SelfTrans_Upper_onUpdate)
GuardStart_JustGuard4_SelfTrans_Upper_onDeactivate = hookup_function(GuardStart_JustGuard4_SelfTrans_Upper_onDeactivate)
GuardDamageSmall_onActivate = hookup_function(GuardDamageSmall_onActivate)
GuardDamageSmall_onUpdate = hookup_function(GuardDamageSmall_onUpdate)
GuardDamageMiddle_onActivate = hookup_function(GuardDamageMiddle_onActivate)
GuardDamageMiddle_onUpdate = hookup_function(GuardDamageMiddle_onUpdate)
GuardDamageLarge_onActivate = hookup_function(GuardDamageLarge_onActivate)
GuardDamageLarge_onUpdate = hookup_function(GuardDamageLarge_onUpdate)
GuardDamageSmall_JustGuard_onActivate = hookup_function(GuardDamageSmall_JustGuard_onActivate)
GuardDamageSmall_JustGuard_onUpdate = hookup_function(GuardDamageSmall_JustGuard_onUpdate)
GuardDamageMiddle_JustGuard_onActivate = hookup_function(GuardDamageMiddle_JustGuard_onActivate)
GuardDamageMiddle_JustGuard_onUpdate = hookup_function(GuardDamageMiddle_JustGuard_onUpdate)
GuardDamageLarge_JustGuard_onActivate = hookup_function(GuardDamageLarge_JustGuard_onActivate)
GuardDamageLarge_JustGuard_onUpdate = hookup_function(GuardDamageLarge_JustGuard_onUpdate)
GuardDamageExLarge_onUpdate = hookup_function(GuardDamageExLarge_onUpdate)
GuardBreak_onUpdate = hookup_function(GuardBreak_onUpdate)
GuardBreakRight_onUpdate = hookup_function(GuardBreakRight_onUpdate)
