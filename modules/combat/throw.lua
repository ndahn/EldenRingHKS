...
SetThrowDefBlendWeight = hookup_function(SetThrowDefBlendWeight)
SetThrowAtkInvalid = hookup_function(SetThrowAtkInvalid)
SetThrowDefInvalid = hookup_function(SetThrowDefInvalid)
SetThrowInvalid = hookup_function(SetThrowInvalid)
ThrowCommonFunction = hookup_function(ThrowCommonFunction)
BackStabCommonFunction = hookup_function(BackStabCommonFunction)
ThrowBackStab_Activate = hookup_function(ThrowBackStab_Activate)
ThrowBackStab_onActivate = hookup_function(ThrowBackStab_onActivate)
ThrowBackStab_onUpdate = hookup_function(ThrowBackStab_onUpdate)
Throw_Activate = hookup_function(Throw_Activate)
Throw_Update = hookup_function(Throw_Update)
Throw_Deactivate = hookup_function(Throw_Deactivate)
ThrowAtk_onActivate = hookup_function(ThrowAtk_onActivate)
ThrowAtk_onUpdate = hookup_function(ThrowAtk_onUpdate)
ThrowDef_onActivate = hookup_function(ThrowDef_onActivate)
ThrowDef_onUpdate = hookup_function(ThrowDef_onUpdate)
ThrowEscape_onUpdate = hookup_function(ThrowEscape_onUpdate)
ThrowDeath_onActivate = hookup_function(ThrowDeath_onActivate)
ThrowDeathIdle_onActivate = hookup_function(ThrowDeathIdle_onActivate)
